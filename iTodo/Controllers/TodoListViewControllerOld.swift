...
class TodoListViewControllerOld: UIViewController, UITextFieldDelegate, NSFetchedResultsControllerDelegate {
...
extension TodoListViewControllerOld : UITableViewDataSource, UITableViewDelegate {
